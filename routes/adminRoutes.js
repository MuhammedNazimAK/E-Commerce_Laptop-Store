...
} = require('../middleware/categoryOfferValidation');
...
adminRoute.get(
  ...
  adminController.loadCustomersListPage
);
adminRoute.get(
  '/customers',
  adminAuth.requireAuth,
  adminController.loadCustomersList
);
adminRoute.patch(
  '/customers',
  adminAuth.requireAuth,
...
adminRoute.get(
  '/latest-orders',
  adminAuth.requireAuth,
  adminController.getLatestOrders
);
adminRoute.get(
  '/dashboard-data',
  adminAuth.requireAuth,
...
adminRoute.get(
  ...
  adminAuth.requireAuth,
  productController.getProductEditPage
);
adminRoute.put(
  '/editProduct/:productId',
  adminAuth.requireAuth,
...
adminRoute.get(
  '/product-offer-list',
  adminAuth.requireAuth,
  productController.getProductOffersPage
);
adminRoute.get(
  '/product-offers',
  adminAuth.requireAuth,
  productController.loadProductOfferPage
);
adminRoute.get(
  '/add-product-offer',
  adminAuth.requireAuth,
  productController.loadAddProductOfferPage
);
adminRoute.post(
  '/add-product-offer',
  adminAuth.requireAuth,
...
adminRoute.get(
  '/edit-product-offer/:id',
  adminAuth.requireAuth,
  productController.loadEditProductOfferPage
);
adminRoute.put(
...
adminRoute.get(
  '/categoryManagement',
  categoryController.loadCategoryManagementPage
);
...
adminRoute.put(
  '/categories/:id',
  adminAuth.requireAuth,
  categoryController.editExistingCategory
);
adminRoute.patch(
  '/categories',
  adminAuth.requireAuth,
...
adminRoute.get(
  '/category-offer-list',
  adminAuth.requireAuth,
  categoryController.getCategoryOffersPage
);
adminRoute.get(
  '/add-category-offer/:id',
  adminAuth.requireAuth,
  categoryController.getCategoryOfferById
);
adminRoute.get(
  '/category-offers',
  adminAuth.requireAuth,
  categoryController.loadCategoryOfferPage
);
adminRoute.get(
  '/add-category-offer',
  adminAuth.requireAuth,
  categoryController.loadAddCategoryOfferPage
);
adminRoute.get(
  '/categories',
  adminAuth.requireAuth,
...
adminRoute.post(
  ...
  adminAuth.requireAuth,
  categoryOfferValidationRules(),
  categoryController.createCategoryOffer
);
adminRoute.put(
  '/add-category-offer/:id',
  adminAuth.requireAuth,
...
adminRoute.get(
  '/orders',
  adminAuth.requireAuth,
  orderController.getOrderManagementPage
);
adminRoute.get(
  '/orders-list',
  adminAuth.requireAuth,
...
adminRoute.put(
  '/edit-order/:id',
  adminAuth.requireAuth,
  orderController.editOrderAdmin
);
adminRoute.put(
  '/edit-return/:orderId/:productId',
  adminAuth.requireAuth,
  orderController.editReturnStatus
);
...
adminRoute.get(
  '/referral-offer-list',
  adminAuth.requireAuth,
  referralOfferController.getReferralOffersPage
);
adminRoute.get(
  '/referral-offers/:id',
  adminAuth.requireAuth,
  referralOfferController.loadReferralOfferPage
);
adminRoute.get(
  '/add-referral-offer',
  adminAuth.requireAuth,
  referralOfferController.loadAddReferralOfferPage
);
adminRoute.post(
  '/add-referral-offer',
  adminAuth.requireAuth,
  referralOfferController.createReferralOffer
);
adminRoute.put(
  '/update-referral-offer/:id',
  adminAuth.requireAuth,
  referralOfferController.updateReferralOffer
);
adminRoute.delete(
  '/delete-referral-offer/:id',
  adminAuth.requireAuth,
  referralOfferController.deleteReferralOffer
);
