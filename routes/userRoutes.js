...
router.get(
  ...
  productController.getProductDetailsViewOnUserPage
);
router.post(
  '/productListing/search-and-sort',
  productController.searchAndSortProducts
);
...
router.get(
  ...
  requireAuth,
  orderController.getRetryCheckoutPage
);
...
router.put(
  '/my-account/cancel-order/:id',
  requireAuth,
  orderController.cancelOrder
);
router.put(
  '/my-account/return-product/:id',
  requireAuth,
