  ...
  try {
    ...
    const wishlistItems = wishlist
      ? wishlist.products.map((item) => ({
          ...
          price:
            item.productId.pricingAndAvailability.salesPrice ||
            item.productId.pricingAndAvailability.regularPrice,
          image: item.productId.images.highResolutionPhotos[0],
          stockAvailability:
            item.productId.pricingAndAvailability.stockAvailability > 0,
