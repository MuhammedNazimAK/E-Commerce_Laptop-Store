        ...
        this.each(function () {
          ...
          function L() {
            ((C = N.data('gall')),
              ...
              (H = N.data('share')),
              o.html(''),
              N.data('vbtype') !== 'iframe' &&
                N.data('vbtype') !== 'inline' &&
                N.data('vbtype') !== 'ajax' &&
                ((Q = {
                  pinterest:
            ...
            return (
              ...
              void n.animate({ opacity: 0 }, 500, function () {
                (y.css('background', w),
                  ...
                  e.data('vbtype') == 'iframe'
                    ? he()
                    : e.data('vbtype') == 'inline'
                      ? pe()
                      : e.data('vbtype') == 'ajax'
                        ? be()
                        : e.data('vbtype') == 'video'
          ...
          function ae(e) {
            (e.keyCode === 27 && te(),
              e.keyCode == 37 && !0 === M && ie(B),
              e.keyCode == 39 && !0 === P && ie(z));
          }
          function te() {
          ...
          ((ee.VBclose = function () {
            ...
            N.on('click', function (k) {
              ...
              return (
                ...
                (S = se.titlePosition == 'top' ? 'bottom' : 'top'),
                o.css(S, '-1px'),
                o.css({
                  color: se.titleColor,
                  fill: se.titleColor,
          ...
          var de = {
            ...
            const ne = function (s) {
              ...
              const a = ue(i, s, s.pageX, s.pageY);
            ...
            const ve = function (s) {
              ...
              let a;
                const t = s.originalEvent.touches[0];
              ((a =
                i == de.UP ? ue(i, s, null, null) : ue(i, s, t.pageX, t.pageY)),
                e(s.target).trigger(a));
            };
            var ue = function (s, i, a, t) {
          ...
          function ke(e) {
            let s;
              ...
              const a =
                ...
                (function (e) {
                  let s = '';
                    const i = decodeURIComponent(e).split('?');
                  if (void 0 !== i[1]) {
                    let a;
                      let t;
                      const o = i[1].split('&');
            ...
            (i.type == 'vimeo'
              ...
              : i.type == 'youtube' && (s = 'https://www.youtube.com/embed/'),
              n.html(
          ...
          function fe() {
            const s = n.outerHeight();
              const i = e(window).height();
            ((f = s + 60 < i ? (i - s) / 2 : '30px'),
              n.css('margin-top', f),
