(function (a) {
  ...
  const c = {
    ...
    const d = { 150: 0, 240: 1, 320: 2, 480: 3, 640: 4 };
    var e = {
      '&': '&amp;',
      '<': '&lt;',
      '>': '&gt;',
        ...
        .get(h, function (c) {
          ...
          if (
            ...
            f.display_profile &&
              ...
              (j += '</div>'));
            const k =
              typeof d[f.image_size] === 'undefined' ? d[640] : d[f.image_size];
            if (f.display_gallery)
              if (typeof c.is_private !== 'undefined' && !0 === c.is_private)
                j +=
                ...
                for (var m = 0; m < s; m++) {
                  var n;
                    var o;
                    var p;
                    const q = 'https://www.instagram.com/p/' + l[m].node.shortcode;
                  ...
                  ((p =
                    ...
                    typeof l[m].node.edge_media_to_caption.edges[0].node
                        .text !==
                      'undefined' &&
                    l[m].node.edge_media_to_caption.edges[0].node.text !== null
                      ? l[m].node.edge_media_to_caption.edges[0].node.text
                      : typeof l[m].node.accessibility_caption !== 'undefined' &&
                          l[m].node.accessibility_caption !== null
            ...
            if (
              f.display_igtv &&
              typeof c.edge_felix_video_timeline !== 'undefined'
            ) {
              const r = c.edge_felix_video_timeline.edges;
                var s = r.length > f.items ? f.items : r.length;
              if (r.length > 0) {
