(function ($) {
  ...
  function mobileOffCanvasMenu() {
    const $offCanvasNav = $('.offcanvas-menu');
      const $offCanvasNavSubMenu = $offCanvasNav.find('.mobile-sub-menu');
   ...
   *****************************************/
  const productSlider4grid2row = new Swiper(
   ...
   **********************************************/
  const productSlider4grid1row = new Swiper(
   ...
   **********************************************/
  const productSliderListview4grid3row = new Swiper(
   ...
   **********************************************/
  const companyLogoSlider = new Swiper('.company-logo-slider.swiper-container', {
    slidesPerView: 7,
    speed: 1500,
   ...
   **********************************/
  const galleryThumbsHorizontal = new Swiper(
  ...
  const gallerylargeHorizonatal = new Swiper(
   ...
   **********************************/
  const galleryThumbsvartical = new Swiper(
  ...
  const gallerylargeVartical = new Swiper(
   ...
   * *********************************/
  const singleSlide = new Swiper('.product-image-single-slide.swiper-container', {
    loop: true,
    speed: 1000,
    spaceBetween: 25,
    slidesPerView: 4,
   ...
   ******************************************************/
  const modalGalleryThumbs = new Swiper('.modal-product-image-thumb', {
    spaceBetween: 10,
    slidesPerView: 4,
    freeMode: true,
    watchSlidesVisibility: true,
  ...
  const modalGalleryTop = new Swiper('.modal-product-image-large', {
    thumbs: {
   ...
   * *********************************/
  const blogListSLider = new Swiper('.blog-list-slider.swiper-container', {
    loop: true,
    speed: 1000,
    slidesPerView: 1,
    navigation: {
