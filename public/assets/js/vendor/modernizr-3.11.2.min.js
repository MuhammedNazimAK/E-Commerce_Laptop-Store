...
!(function (e, t, n, r) {
  ...
  function s(e, t) {
    if (typeof e === 'object') for (const n in e) k(e, n) && s(n, e[n]);
    else {
      e = e.toLowerCase();
      const r = e.split('.');
        let o = Modernizr[r[0]];
  ...
  (Modernizr.addTest('websockets', M),
    ...
    (function () {
      ...
      for (
        ...
        ((e = n[r].toLowerCase()),
          (t = y('column' + n[r])),
          (e !== 'breakbefore' && e !== 'breakafter' && e !== 'breakinside') ||
            (t = t || y(n[r])),
  ...
  for (let W = 0; W < Modernizr._q.length; W++) Modernizr._q[W]();
