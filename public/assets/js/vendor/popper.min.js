...
!(function (e, t) {
  ...
  function h(e) {
    if (!i(e) || c(e).position === 'fixed') return null;
    if ((e = e.offsetParent)) {
      const t = s(e);
      if (
        a(e) === 'body' &&
  ...
  function g(e) {
    for (
      var t = n(e), r = h(e);
      r &&
      ['table', 'td', 'th'].indexOf(a(r)) >= 0 &&
      c(r).position === 'static';

    )
      r = h(r);
    if (r && a(r) === 'body' && c(r).position === 'static') return t;
    if (!r)
      e: {
        for (e = d(e); i(e) && ['html', 'body'].indexOf(a(e)) < 0; ) {
          if (
            (r = c(e)).transform !== 'none' ||
            r.perspective !== 'none' ||
            (r.willChange && r.willChange !== 'auto')
          ) {
            r = e;
            break e;
          }
      ...
      (t =
        t === 'clippingParents'
          ? (function (e) {
              const t = m(d(e));
                const n =
                  ['absolute', 'fixed'].indexOf(c(e).position) >= 0 && i(e)
                    ? g(e)
                    : e;
              return o(n)
                ? t.filter(function (e) {
                    return o(e) && O(e, n) && a(e) !== 'body';
                  })
                : [];
            })(e)
          : [].concat(t)),
  ...
  function E(e) {
    const t = e.reference;
      const n = e.element;
      let r = (e = e.placement) ? y(e) : null;
    e = e ? e.split('-')[1] : null;
    let o = t.x + t.width / 2 - n.width / 2;
      let i = t.y + t.height / 2 - n.height / 2;
    switch (r) {
      case 'top':
  ...
  function L(e, n) {
    ...
    let i = r.boundary;
      let a = void 0 === i ? 'clippingParents' : i;
      let f = void 0 === (i = r.rootBoundary) ? 'viewport' : i;
    i = void 0 === (i = r.elementContext) ? 'popper' : i;
    let c = r.altBoundary;
      let p = void 0 !== c && c;
    r = D(
      typeof (r = void 0 === (r = r.padding) ? 0 : r) !== 'number' ? r : P(r, T)
    );
    const l = e.elements.reference;
    ((c = e.rects.popper),
      (a = j(
        o((p = e.elements[p ? (i === 'popper' ? 'reference' : 'popper') : i]))
          ? p
    ...
    if (((e = e.modifiersData.offset), i === 'popper' && e)) {
      ...
      Object.keys(u).forEach(function (e) {
        const t = ['right', 'bottom'].indexOf(e) >= 0 ? 1 : -1;
          const n = ['top', 'bottom'].indexOf(e) >= 0 ? 'y' : 'x';
        u[e] += d[n] * t;
      });
    }
    return u;
  ...
  function B(e) {
    ...
    const t = e.defaultModifiers;
      const n = void 0 === t ? [] : t;
      const r = void 0 === (e = e.defaultOptions) ? V : e;
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (k(t, (e = e.popper)))
                for (
                  s.rects = {
                    reference: l(t, g(e), s.options.strategy === 'fixed'),
                    popper: u(e),
                  },
                    s.reset = !1,
  ...
  var T = ['top', 'bottom', 'right', 'left'];
    const q = T.reduce(function (e, t) {
      return e.concat([t + '-start', t + '-end']);
    }, []);
    const C = [].concat(T, ['auto']).reduce(function (e, t) {
    ...
    const _ = {
      ...
      effect: function (e) {
        const t = e.state;
          const r = e.instance;
          const o = (e = e.options).scroll;
          const i = void 0 === o || o;
          const a = void 0 === (e = e.resize) || e;
          const s = n(t.elements.popper);
          const f = [].concat(t.scrollParents.reference, t.scrollParents.popper);
        return (
          i &&
            f.forEach(function (e) {
    ...
    const Y = {
      ...
      fn: function (e) {
        const t = e.state;
          const n = e.name;
          const r = void 0 === (e = e.options.offset) ? [0, 0] : e;
          let o = (e = C.reduce(function (e, n) {
            let o = t.rects;
              let i = y(n);
              const a = ['left', 'top'].indexOf(i) >= 0 ? -1 : 1;
              let s =
                typeof r === 'function'
      ...
      fn: function (e) {
        ...
        if (((e = e.name), !t.modifiersData[e]._skip)) {
          ...
          let i = n.fallbackPlacements;
            const a = n.padding;
            const s = n.boundary;
            const f = n.rootBoundary;
            const c = n.altBoundary;
            let p = n.flipVariations;
            const l = void 0 === p || p;
            ...
            return e.concat(
              y(n) === 'auto'
                ? (function (e, t) {
                    void 0 === t && (t = {});
                    const n = t.boundary;
                      const r = t.rootBoundary;
                      const o = t.padding;
                      let i = t.flipVariations;
                      const a = t.allowedAutoPlacements;
                      const s = void 0 === a ? C : a;
                      const f = t.placement.split('-')[1];
                    (i = (t = f
                        ? i
                          ? q
                          : q.filter(function (e) {
          ...
          for (var h = d[0], g = 0; g < d.length; g++) {
            const v = d[g];
              const b = y(v);
              let O = v.split('-')[1] === 'start';
              let w = ['top', 'bottom'].indexOf(b) >= 0;
              let x = w ? 'width' : 'height';
              const j = L(t, {
                placement: v,
                boundary: s,
                rootBoundary: f,
    ...
    const Q = {
      ...
      fn: function (e) {
        ...
        ((n = L(t, {
          ...
          (a = y(t.placement)));
        let f = t.placement.split('-')[1];
          let c = !f;
          const p = M(a);
        a = p === 'x' ? 'y' : 'x';
        const l = t.modifiersData.popperOffsets;
          let d = t.rects.reference;
          let m = t.rects.popper;
          let h =
            typeof s === 'function'
              ? s(
                  Object.assign(
        ...
        if (((s = { x: 0, y: 0 }), l)) {
          if (o) {
            let v = p === 'y' ? 'top' : 'left';
              let b = p === 'y' ? 'bottom' : 'right';
              const O = p === 'y' ? 'height' : 'width';
            o = l[p];
            const w = l[p] + n[v];
              const x = l[p] - n[b];
              const j = i ? -m[O] / 2 : 0;
              let E = f === 'start' ? d[O] : m[O];
            ((f = f === 'start' ? -m[O] : -d[O]),
              (m = t.elements.arrow),
              (m = i && m ? u(m) : { width: 0, height: 0 }));
            const D = t.modifiersData['arrow#persistent']
            ...
            ((v = D[v]),
              ...
              (h =
                ...
                E -
                d -
                (h ? (p === 'y' ? h.clientTop || 0 : h.clientLeft || 0) : 0)),
              (c = l[p] + c - d),
              (i = Math.max(
                i ? Math.min(w, h) : w,
          ...
          (r &&
            ...
            (i = Math.max(
              r + n[p === 'x' ? 'top' : 'left'],
              Math.min(r, r - n[p === 'x' ? 'bottom' : 'right'])
            )),
            (l[a] = i),
            (s[a] = i - r)),
            (t.modifiersData[e] = s));
    ...
    const Z = {
      ...
      fn: function (e) {
        let t;
          const n = e.state;
        e = e.name;
        let r = n.elements.arrow;
          let o = n.modifiersData.popperOffsets;
          let i = y(n.placement);
          const a = M(i);
        if (
          ((i = ['left', 'right'].indexOf(i) >= 0 ? 'height' : 'width'), r && o)
        ) {
          const s = n.modifiersData[e + '#persistent'].padding;
            const f = u(r);
      ...
      effect: function (e) {
        ...
        if (
          ...
          if (typeof r === 'string' && !(r = t.elements.popper.querySelector(r)))
            return;
          O(t.elements.popper, r) &&
            ((t.elements.arrow = r),
            (t.modifiersData[e + '#persistent'] = {
              padding: D(typeof n !== 'number' ? n : P(n, T)),
            }));
        }
      },
      requires: ['popperOffsets'],
    ...
    const $ = {
      ...
      fn: function (e) {
        ...
        let n = t.rects.reference;
          let r = t.rects.popper;
          let o = t.modifiersData.preventOverflow;
          const i = L(t, { elementContext: 'reference' });
          let a = L(t, { altBoundary: !0 });
        ((n = R(i, n)),
          (r = R(a, r, o)),
          (o = S(n)),
          (a = S(r)),
    ...
    const ee = B({ defaultModifiers: [_, U, F, X] });
    const te = [_, U, F, X, Y, K, Q, Z, $];
    const ne = B({ defaultModifiers: te });
  ((e.applyStyles = X),
    (e.arrow = Z),
    (e.computeStyles = F),
    (e.createPopper = ne),
