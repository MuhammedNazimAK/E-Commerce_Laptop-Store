...
!(function (t, e) {
   ...
   */ const r = {
    ...
    const c = (t) => l[15 & t];
    const h = (t) => l[(240 & t) >> 4] + l[15 & t];
    const d = (t) => (240 & t) >> 4 == (15 & t);
  function u(t) {
    const e = (function (t) {
  ...
  class z {
    ...
    greyscale() {
      const t = this._rgb;
        const e = f(0.3 * t.r + 0.59 * t.g + 0.11 * t.b);
  ...
  function pt(t, e, i) {
    return typeof e === 'string' ? ot(gt(t, e), i) : ot(gt(t, ''), e);
  }
  const mt = new (class {
    constructor(t) {
  ...
  const xt = Math.PI;
    const bt = 2 * xt;
    const _t = bt + xt;
    const yt = Number.POSITIVE_INFINITY;
    const vt = xt / 180;
    const wt = xt / 2;
    const Mt = xt / 4;
    const kt = (2 * xt) / 3;
  ...
  function Yt(t, e, i, n) {
    let o = ((n = n || {}).data = n.data || {});
      let s = (n.garbageCollect = n.garbageCollect || []);
    (n.font !== e &&
    ...
    let l, c, h, d, u;
    for (l = 0; l < r; l++)
      if (((d = i[l]), d != null && !0 !== Y(d))) a = $t(t, o, s, a, d);
      else if (Y(d))
        for (c = 0, h = d.length; c < h; c++)
          ((u = d[c]), u == null || Y(u) || (a = $t(t, o, s, a, u)));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
  ...
  function Ut(t, e, i) {
    const n = t.currentDevicePixelRatio;
      const o = i !== 0 ? Math.max(i / 2, 0.5) : 0;
  ...
  function Qt(t, e, i, n, o) {
    ...
    } else (o === 'after') != !!n ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y);
    t.lineTo(i.x, i.y);
  }
  function Jt(t, e, i, n) {
    if (!e) return t.lineTo(i.x, i.y);
  ...
  function te(t, e, i, n, o, s = {}) {
    const a = Y(e) ? e : [e];
      const r = s.strokeWidth > 0 && s.strokeColor !== '';
    let l, c;
    for (
      t.save(),
      ...
      if (
        ...
        const e = t.measureText(c);
          const o = i - e.actualBoundingBoxLeft;
          const a = i + e.actualBoundingBoxRight;
          const r = n - e.actualBoundingBoxAscent;
          const l = n + e.actualBoundingBoxDescent;
          const h = s.strikethrough ? (r + l) / 2 : l;
  ...
  const ne = (t, e, i) => ie(t, i, (n) => t[n][e] < i);
    const oe = (t, e, i) => ie(t, i, (n) => t[n][e] >= i);
  function se(t, e, i) {
    let n = 0;
      let o = t.length;
    for (; n < o && t[n] < e; ) n++;
  ...
  function de(t, e, i) {
    ...
    return (
      typeof t === 'string'
        ? ((n = parseInt(t, 10)),
          t.indexOf('%') !== -1 && (n = (n / 100) * e.parentNode[i]))
        : (n = t),
      n
    );
  }
  ...
  function me(t, e) {
    const { canvas: i, currentDevicePixelRatio: n } = e;
      const o = ue(i);
      const s = o.boxSizing === 'border-box';
      const a = pe(o, 'padding');
      const r = pe(o, 'border', 'width');
      const {
        x: l,
        y: c,
        box: h,
        ...
        const i = t.native || t;
          const n = i.touches;
          const o = n && n.length ? n[0] : i;
          const { offsetX: s, offsetY: a } = o;
        let r;
          let l;
          let c = !1;
        if (
  ...
  function be(t, e, i, n) {
    const o = ue(t);
      const s = pe(o, 'margin');
      const a = de(o.maxWidth, t, 'clientWidth') || yt;
      const r = de(o.maxHeight, t, 'clientHeight') || yt;
        ...
        if (void 0 === e || void 0 === i) {
          ...
          if (s) {
            const t = s.getBoundingClientRect();
              const a = ue(s);
              const r = pe(a, 'border', 'width');
              const l = pe(a, 'padding');
  ...
  function _e(t, e, i) {
    const n = (t.currentDevicePixelRatio = e || 1);
      const { canvas: o, width: s, height: a } = t;
    ((o.height = a * n),
      (o.width = s * n),
  ...
  function Me(t, e, i, n) {
    const { controller: o, data: s, _sorted: a } = t;
      const r = o._cachedMeta.iScale;
    if (r && e === r.axis && a && s.length) {
      const t = r._reversePixels ? oe : ne;
      if (!n) return t(s, e, i);
      if (o._sharedOptions) {
        const n = s[0];
          const o = typeof n.getRange === 'function' && n.getRange(e);
        if (o) {
          const n = t(s, e, i - o);
            const a = t(s, e, i + o);
  ...
  const Ce = {
    modes: {
      index(t, e, i, n) {
        const o = we(e, t);
          const s = i.axis || 'x';
          const a = i.intersect ? Se(t, o, s, n) : Pe(t, o, s, !1, n);
          const r = [];
        return a.length
  ...
  function Re(t, e) {
    const i = {};
      const n = U(e);
      const o = n ? Object.keys(e) : e;
      const s = U(t) ? (n ? (i) => K(t[i], t[e[i]]) : (e) => t[e]) : () => t;
  ...
  function ze(t, e, i, n) {
    ...
    for (o = 0, s = t.length; o < s; ++o)
      if (
        ((a = t[o]),
        void 0 !== a &&
          (void 0 !== e && typeof a === 'function' && ((a = a(e)), (r = !1)),
  ...
  function Ne(t, e) {
    return t.filter((t) => Be.indexOf(t.pos) === -1 && t.box.axis === e);
  }
  function He(t, e) {
    return t.sort((t, i) => {
      const n = e ? i : t;
  ...
  function Ye(t, e, i) {
    ...
    const s = Math.max(0, e.outerWidth - je(o, t, 'left', 'right'));
      const a = Math.max(0, e.outerHeight - je(o, t, 'top', 'bottom'));
      const r = s !== t.w;
      const l = a !== t.h;
    return (
      (t.w = s),
      ...
      const o = Ie(t.options.layout.padding);
        ...
        const r = (function (t) {
          const e = (function (t) {
            ...
            const n = He(We(e, 'left'), !0);
            const o = He(We(e, 'right'));
            const s = He(We(e, 'top'), !0);
            const a = He(We(e, 'bottom'));
            const r = Ne(e, 'x');
            const l = Ne(e, 'y');
          return {
            fullSize: i,
  ...
  class hi extends Ge {
    ...
    addEventListener(t, e, i) {
      ...
      const n = t.$proxies || (t.$proxies = {});
        const o = { attach: ii, detach: ni, resize: ri }[e] || ci;
      n[e] = o(t, e, i);
    }
  ...
  const ui = (t) => t === 0 || t === 1;
    ...
    const gi = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) + 1;
    const pi = {
      linear: (t) => t,
      easeInQuad: (t) => t * t,
      easeOutQuad: (t) => -t * (t - 2),
  ...
  function vi(t, e) {
    const i = (t && t.options) || {};
      const n = i.reverse;
      const o = void 0 === i.min ? e : 0;
      const s = void 0 === i.max ? e : 0;
  ...
  function Pi(t, e) {
    const { chart: i, _cachedMeta: n } = t;
      const o = i._stacks || (i._stacks = {});
      const { iScale: s, vScale: a, index: r } = n;
      const l = s.axis;
      const c = a.axis;
  ...
  const Oi = (t) => t === 'reset' || t === 'none';
    const Ai = (t, e) => (e ? t : Object.assign({}, t));
  class Ti {
    constructor(t, e) {
      ((this.chart = t),
        (this._ctx = t.ctx),
    ...
    linkScales() {
      const t = this;
        const e = t.chart;
        const i = t._cachedMeta;
        const n = t.getDataset();
        const o = (t, e, i, n) => (t === 'x' ? e : t === 'r' ? n : i);
        const s = (i.xAxisID = K(n.xAxisID, Di(e, 'x')));
        const a = (i.yAxisID = K(n.yAxisID, Di(e, 'y')));
        const r = (i.rAxisID = K(n.rAxisID, Di(e, 'r')));
        const l = i.indexAxis;
        const c = (i.iAxisID = o(l, s, a, r));
        const h = (i.vAxisID = o(l, a, s, r));
    ...
    buildOrUpdateElements(t) {
      const e = this;
        const i = e._cachedMeta;
        const n = e.getDataset();
      let o = !1;
      (e._dataCheck(),
    ...
    configure() {
      const t = this;
        const e = t.chart.config;
        const i = e.datasetScopeKeys(t._type);
        const n = e.getOptionScopes(t.getDataset(), i, !0);
    ...
    parse(t, e) {
      const i = this;
        const { _cachedMeta: n, _data: o } = i;
        const { iScale: s, _stacked: a } = n;
        const r = s.axis;
      let l;
        let c;
        let h;
        let d = (t === 0 && e === o.length) || n._sorted;
        let u = t > 0 && n._parsed[t - 1];
    ...
    getMinMax(t, e) {
      const i = this;
        const n = i._cachedMeta;
        const o = n._parsed;
        const s = n._sorted && t === n.iScale;
        const a = o.length;
        const r = i._getOtherScale(t);
        const l = e && n._stacked && { keys: wi(i.chart, !0), values: null };
        const c = { min: Number.POSITIVE_INFINITY, max: Number.NEGATIVE_INFINITY };
        const { min: h, max: d } = (function (t) {
          const {
            min: e,
            max: i,
            minDefined: n,
    ...
    draw() {
      const t = this;
        const e = t._ctx;
        const i = t.chart;
        const n = t._cachedMeta;
        const o = n.data || [];
        const s = i.chartArea;
        const a = [];
        const r = t._drawStart || 0;
        const l = t._drawCount || o.length - r;
      let c;
    ...
    _resolveElementOptions(t, e = 'default', i) {
      const n = this;
        const o = e === 'active';
        const s = n._cachedDataOpts;
        const a = t + '-' + e;
        const r = s[a];
        const l = n.enableOptionSharing && ht(i);
      if (r) return Ai(r, l);
      const c = n.chart.config;
        const h = c.datasetElementScopeKeys(n._type, t);
        const d = o ? [t + 'Hover', 'hover', t, ''] : [t, ''];
        const u = c.getOptionScopes(n.getDataset(), h);
        const f = Object.keys(mt.elements[t]);
        const g = c.resolveNamedOptions(u, f, () => n.getContext(i, o), d);
      return (
        g.$shared && ((g.$shared = l), (s[a] = Object.freeze(Ai(g, l)))),
        g
      );
    }
    ...
    _resolveAnimations(t, e, i) {
      ...
      if (!1 !== o.options.animation) {
        const o = n.chart.config;
          const s = o.datasetAnimationScopeKeys(n._type, e);
          const a = o.getOptionScopes(n.getDataset(), s);
    ...
    _resyncElements(t) {
      const e = this;
        const i = e._cachedMeta.data.length;
        const n = e._data.length;
      n > i
  ...
  const Ii = {
    ...
    numeric(t, e, i) {
      ...
      const a = St(Math.abs(s));
        ...
        const l = { notation: o, minimumFractionDigits: r, maximumFractionDigits: r };
      ...
      const n =
        ...
        (function (t) {
          const e = t.options.offset;
            ...
            const o = t._maxLength / i;
          return Math.floor(Math.min(n, o));
        })(t);
      const o = i.major.enabled
        ? (function (t) {
            const e = [];
            let i, n;
  ...
  function Vi(t, e, i, n, o) {
    const s = K(n, 0);
      const a = Math.min(K(o, t.length), t.length);
    let r;
      let l;
      let c;
      let h = 0;
  ...
  const Bi = (t, e, i) => (e === 'top' || e === 'left' ? t[e] + i : t[e] - i);
  function Wi(t, e) {
    const i = [];
      const n = t.length / e;
      const o = t.length;
  ...
  function Ni(t, e, i) {
    const n = t.ticks.length;
      const o = Math.min(e, n - 1);
      const s = t._startPixel;
      const a = t._endPixel;
      const r = 1e-6;
    let l;
      let c = t.getPixelForTick(o);
    if (
      !(
        i &&
        ((l =
  ...
  function $i(t, e, i) {
    ...
    return (
      ((i && e !== 'right') || (!i && e === 'right')) &&
        (o = ((t) => (t === 'left' ? 'right' : t === 'right' ? 'left' : t))(o)),
      o
    );
  }
  class Yi extends Ri {
    ...
    getMinMax(t) {
      const e = this;
      let i;
        let { min: n, max: o, minDefined: s, maxDefined: a } = e.getUserBounds();
    ...
    update(t, e, i) {
      const n = this;
        const o = n.options.ticks;
        const s = o.sampleSize;
      (n.beforeUpdate(),
        (n.maxWidth = t),
        (n.maxHeight = e),
        (n._margins = i =
    ...
    calculateLabelRotation() {
      const t = this;
        ...
        const i = e.ticks;
        const n = t.ticks.length;
        const o = i.minRotation || 0;
        const s = i.maxRotation;
      let a;
        let r;
        let l;
        let c = o;
      ...
      const h = t._getLabelSizes();
        ...
        const f = Nt(t.chart.width - d, 0, t.maxWidth);
    ...
    _calculatePadding(t, e, i, n) {
      const o = this;
        ...
        const l = o.labelRotation !== 0;
        const c = r !== 'top' && o.axis === 'x';
      if (o.isHorizontal()) {
        const r = o.getPixelForTick(0) - o.left;
          const h = o.right - o.getPixelForTick(o.ticks.length - 1);
        let d = 0;
          let u = 0;
        (l
          ? c
    ...
    _computeLabelSizes(t, e) {
      ...
      const _ = o.indexOf(x);
        const y = s.indexOf(b);
        const v = (t) => ({ width: o[t] || 0, height: s[t] || 0 });
    ...
    _tickSize() {
      const t = this;
        ...
        const i = Lt(t.labelRotation);
        const n = Math.abs(Math.cos(i));
        const o = Math.abs(Math.sin(i));
        const s = t._getLabelSizes();
        const a = e.autoSkipPadding || 0;
        const r = s ? s.widest.width + a : 0;
        const l = s ? s.highest.height + a : 0;
    ...
    _computeGridLineItems(t) {
      const e = this;
        ...
        const n = e.chart;
        const o = e.options;
        const { grid: s, position: a } = o;
        const r = s.offset;
        const l = e.isHorizontal();
        const c = e.ticks.length + (r ? 1 : 0);
        const h = Hi(s);
        const d = [];
        const u = s.setContext(e.getContext(0));
        const f = u.drawBorder ? u.borderWidth : 0;
        const g = f / 2;
        const p = function (t) {
          return Ut(n, t, f);
        };
      ...
      if (a === 'top')
        ...
        if (a === 'center') m = p((t.top + t.bottom) / 2 + 0.5);
        else if (U(a)) {
        ...
        if (a === 'center') m = p((t.left + t.right) / 2);
        else if (U(a)) {
          const t = Object.keys(a)[0];
            const i = a[t];
          m = p(e.chart.scales[t].getPixelForValue(i));
      ...
      for (x = 0; x < c; ++x) {
        const t = s.setContext(e.getContext(x));
          const i = t.lineWidth;
          const o = t.color;
          const a = s.borderDash || [];
          const c = t.borderDashOffset;
          const h = t.tickWidth;
          const u = t.tickColor;
          const f = t.tickBorderDash || [];
          const g = t.tickBorderDashOffset;
        ((b = Ni(e, x, r)),
          void 0 !== b &&
            ((_ = Ut(n, b, i)),
    ...
    _computeLabelItems(t) {
      const e = this;
        const i = e.axis;
        const n = e.options;
        const { position: o, ticks: s } = n;
        const a = e.isHorizontal();
        const r = e.ticks;
        const { align: l, crossAlign: c, padding: h, mirror: d } = s;
        const u = Hi(n.grid);
        const f = u + h;
        const g = d ? -h : f;
        const p = -Lt(e.labelRotation);
        const m = [];
      let x;
        let b;
        let _;
        ...
        let C;
        let O = 'middle';
      if (o === 'top') ((w = e.bottom - g), (M = e._getXAxisLabelAlignment()));
      else if (o === 'bottom')
        ...
        if (o === 'center') w = (t.top + t.bottom) / 2 + f;
        else if (U(o)) {
        ...
        if (o === 'center') v = (t.left + t.right) / 2 - f;
        else if (U(o)) {
          const t = Object.keys(o)[0];
            const i = o[t];
    ...
    _getXAxisLabelAlignment() {
      ...
      if (-Lt(this.labelRotation)) return t === 'top' ? 'left' : 'right';
      let i = 'center';
      return (
        e.align === 'start' ? (i = 'left') : e.align === 'end' && (i = 'right'),
        i
      );
    }
    ...
    _getYAxisLabelAlignment(t) {
      const e = this;
        ...
        const a = t + s;
        const r = e._getLabelSizes().widest.width;
      let l, c;
      return (
        i === 'left'
          ? o
    ...
    drawGrid(t) {
      const e = this;
        ...
        const n = e.ctx;
        const o = e.chart;
        const s = i.setContext(e.getContext());
        const a = i.drawBorder ? s.borderWidth : 0;
        const r = e._gridLineItems || (e._gridLineItems = e._computeGridLineItems(t));
      let l, c;
      const h = (t, e, i) => {
        i.width &&
          i.color &&
    ...
    getMatchingVisibleMetas(t) {
      const e = this;
        const i = e.chart.getSortedVisibleDatasetMetas();
        const n = e.axis + 'AxisID';
        const o = [];
      let s, a;
            ...
            Y(r) &&
              ...
              (r = (function (t, e, i, n) {
                ...
                if (ht(s.index) && n(t)) e = e[s.index % e.length];
                  ...
                  const i = e;
                    const n = o._scopes.filter((t) => t !== i);
                  e = [];
                  for (const l of i) {
                    const i = en(n, o, t, l);
  ...
  const Ji = (t, e) =>
    !0 === t ? e : typeof t === 'string' ? lt(e, t) : void 0;
  function tn(t, e, i, n) {
    for (const o of e) {
      const e = Ji(i, o);
      if (e) {
  ...
  const an = Number.EPSILON || 1e-14;
    const rn = (t, e) => e < t.length && !t[e].skip && t[e];
  function ln(t, e, i, n) {
    const o = t.skip ? e : t;
      const s = e;
      const a = i.skip ? e : i;
  ...
  function yn(t, e, i) {
    ...
    const { property: n, start: o, end: s } = i;
      const a = e.length;
      const { compare: r, between: l, normalize: c } = bn(n);
      const {
        start: h,
        end: d,
        loop: u,
        ...
        const { property: n, start: o, end: s } = i;
          const { between: a, normalize: r } = bn(n);
          const l = e.length;
        let c;
          let h;
    ...
    let p;
      ...
      let b = !1;
      let _ = null;
    const y = () => b || (l(o, x, p) && r(o, x) !== 0);
      const v = () => !b || r(s, p) === 0 || l(s, x, p);
    for (let t = h, i = h; t <= d; ++t)
      ((m = e[t % a]),
        m.skip ||
          ((p = c(m[n])),
          (b = l(p, o, s)),
          _ === null && y() && (_ = r(p, o) === 0 ? t : i),
          _ !== null &&
            v() &&
  ...
  function wn(t, e) {
    const i = t.points;
      const n = t.options.spanGaps;
      const o = i.length;
    if (!o) return [];
    const s = !!t._loop;
      const { start: a, end: r } = (function (t, e, i, n) {
        let o = 0;
          let s = e - 1;
    ...
    return Mn(
      (function (t, e, i, n) {
        ...
        return (r !== null && s.push({ start: e % o, end: r % o, loop: n }), s);
      })(i, a, r < a ? r + o : r, !!t._fullLoop && a === 0 && r === o - 1),
      i,
      e
    );
  }
  ...
  class On {
    ...
    _createDescriptors(t, e) {
      const i = t && t.config;
        const n = K(i.options && i.options.plugins, {});
        const o = (function (t) {
          const e = [];
            const i = Object.keys(Cn.plugins.items);
  ...
  class Wn {
    ...
    getOptionScopes(t, e, i) {
      const { options: n, type: o } = this;
        const s = this._cachedScopes(t, i);
        const a = s.get(e);
      if (a) return a;
      const r = new Set();
      e.forEach((e) => {
    ...
    resolveNamedOptions(t, e, i, n = ['']) {
      const o = { $shared: !0 };
        const { resolver: s, subPrefixes: a } = Nn(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
  ...
  function jn(t, e) {
    return t === 'top' || t === 'bottom' || (Hn.indexOf(t) === -1 && e === 'x');
  }
  function $n(t, e) {
    return function (i, n) {
  ...
  class Zn {
    ...
    _resize(t, e) {
      const i = this;
        const n = i.options;
        const o = i.canvas;
        const s = n.maintainAspectRatio && i.aspectRatio;
        const a = i.platform.getMaximumSize(o, t, e, s);
        const r = i.currentDevicePixelRatio;
        const l = n.devicePixelRatio || i.platform.getDevicePixelRatio();
    ...
    buildOrUpdateScales() {
      const t = this;
        ...
        const i = e.scales;
        const n = t.scales;
        const o = Object.keys(n).reduce((t, e) => ((t[e] = !1), t), {});
      let s = [];
      (i &&
        (s = s.concat(
          Object.keys(i).map((t) => {
    ...
    _removeUnreferencedMetasets() {
      ...
      (e.length > i.length && delete t._stacks,
        e.forEach((e, n) => {
          i.filter((t) => t === e._dataset).length === 0 &&
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          const i = Cn.getController(a);
            const { datasetElementType: o, dataElementType: r } = mt.datasets[a];
    ...
    _updateDataset(t, e) {
      const i = this;
        const n = i.getDatasetMeta(t);
        const o = { meta: n, index: t, mode: e, cancelable: !0 };
    ...
    _updateDatasetVisibility(t, e) {
      const i = this;
        const n = e ? 'show' : 'hide';
        const o = i.getDatasetMeta(t);
        const s = o.controller._resolveAnimations(void 0, n);
    ...
    setActiveElements(t) {
      const e = this;
        const i = e._active || [];
        const n = t.map(({ datasetIndex: t, index: i }) => {
    ...
    _eventHandler(t, e) {
      const i = this;
        ...
        const o = (e) => (e.options.events || this.options.events).includes(t.type);
      ...
      Y(t)
        ? (function (t, e, i, n) {
            const o = i.parse(t[0], n);
              const s = i.parse(t[1], n);
              const a = Math.min(o, s);
              const r = Math.max(o, s);
            let l = a;
              let c = r;
  ...
  class ro extends Ti {
    ...
    updateElements(t, e, i, n) {
      const o = this;
        const s = n === 'reset';
        const a = o._cachedMeta.vScale;
        const r = a.getBasePixel();
        const l = a.isHorizontal();
        const c = o._getRuler();
        const h = o.resolveDataElementOptions(e, n);
        const d = o.getSharedOptions(h);
        const u = o.includeOptions(n, d);
      ...
      for (let h = e; h < e + i; h++) {
        const e = o.getParsed(h);
          ...
          const f = o._calculateBarIndexPixels(h, c);
          const g = {
            horizontal: l,
            base: i.base,
            x: l ? i.head : f.center,
    ...
    _getStacks(t, e) {
      const i = this._cachedMeta.iScale;
        const n = i.getMatchingVisibleMetas(this._type);
    ...
    _getStackIndex(t, e) {
      const i = this._getStacks(t);
        const n = void 0 !== e ? i.indexOf(e) : -1;
    ...
    _calculateBarValuePixels(t) {
      const e = this;
        const { vScale: i, _stacked: n } = e._cachedMeta;
        const { base: o, minBarLength: s } = e.options;
        const a = e.getParsed(t);
        const r = a._custom;
        const l = ao(r);
      let c;
        let h;
        let d = a[i.axis];
        let u = 0;
        let f = n ? e.applyStack(i, a, n) : d;
      (f !== d && ((u = f - d), (f = d)),
        l &&
          ((d = r.barStart),
          (f = r.barEnd - r.barStart),
          d !== 0 && Pt(d) !== Pt(r.barEnd) && (u = 0),
          (u += d)));
      const g = $(o) || l ? u : o;
    ...
    _calculateBarIndexPixels(t, e) {
      const i = this;
        const n = e.scale;
        const o = i.options;
        const s = K(o.maxBarThickness, 1 / 0);
      let a, r;
      if (e.grouped) {
        const n = o.skipNull ? i._getStackCount(t) : e.stackCount;
            ...
            o.barThickness === 'flex'
              ? (function (t, e, i, n) {
                  ...
                  let a = t > 0 ? o[t - 1] : null;
                    let r = t < o.length - 1 ? o[t + 1] : null;
                  const l = i.categoryPercentage;
                  (a === null &&
                    (a = s - (r === null ? e.end - e.start : r - s)),
                    r === null && (r = s + s - a));
          ...
          const c = i._getStackIndex(i.index, i._cachedMeta.stack);
    ...
    draw() {
      ...
      for (Gt(e.ctx, e.chartArea); a < s; ++a)
        t.getParsed(a)[n.axis] !== null && o[a].draw(t._ctx);
      Zt(e.ctx);
    }
  }
  ((ro.id = 'bar'),
  ...
  class lo extends Ti {
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta;
        ...
        const o = this.getParsed(t);
        const s = i.getLabelForValue(o.x);
        const a = n.getLabelForValue(o.y);
        const r = o._custom;
      return {
        label: e.label,
        value: '(' + s + ', ' + a + (r ? ', ' + r : '') + ')',
    ...
    updateElements(t, e, i, n) {
      const o = this;
        const s = n === 'reset';
        const { xScale: a, yScale: r } = o._cachedMeta;
        const l = o.resolveDataElementOptions(e, n);
        const c = o.getSharedOptions(l);
        const h = o.includeOptions(n, c);
      for (let l = e; l < e + i; l++) {
        const e = t[l];
          const i = !s && o.getParsed(l);
          const c = s ? a.getPixelForDecimal(0.5) : a.getPixelForValue(i.x);
          const d = s ? r.getBasePixel() : r.getPixelForValue(i.y);
          const u = { x: c, y: d, skip: isNaN(c) || isNaN(d) };
        (h &&
  ...
  class co extends Ti {
      ...
      for (let n = 0; n < i.chart.data.datasets.length; ++n)
        if (i.chart.isDatasetVisible(n)) {
          const o = i.chart.getDatasetMeta(n).controller;
            const s = o._getRotation();
            const a = o._getCircumference();
    ...
    update(t) {
      const e = this;
        const i = e.chart;
        const { chartArea: n } = i;
        const o = e._cachedMeta;
        const s = o.data;
        const a = e.getMaxBorderWidth() + e.getMaxOffset(s);
        const r = Math.max((Math.min(n.width, n.height) - a) / 2, 0);
        const l = Math.min(G(e.options.cutout, r), 1);
        const c = e._getRingWeight(e.index);
        const { circumference: h, rotation: d } = e._getRotationExtents();
        const {
          ratioX: u,
          ratioY: f,
          offsetX: g,
          ...
          if (e < bt) {
            const r = t;
              ...
              const d = Math.cos(l);
              const u = Math.sin(l);
              const f = (t, e, n) => (Wt(t, r, l) ? 1 : Math.max(e, e * i, n, n * i));
              const g = (t, e, n) =>
        ...
        const m = (n.width - a) / u;
        const x = (n.height - a) / f;
        const b = Math.max(Math.min(m, x) / 2, 0);
        const _ = Z(e.options.radius, b);
        const y = (_ - Math.max(_ * l, 0)) / e._getVisibleDatasetWeightTotal();
      ((e.offsetX = g * _),
        (e.offsetY = p * _),
    ...
    _circumference(t, e) {
      const i = this;
        const n = i.options;
        const o = i._cachedMeta;
        const s = i._getCircumference();
    ...
    updateElements(t, e, i, n) {
      const o = this;
        ...
        const h = (r.top + r.bottom) / 2;
        const d = s && l.animateScale;
        const u = d ? 0 : o.innerRadius;
        const f = d ? 0 : o.outerRadius;
        const g = o.resolveDataElementOptions(e, n);
        const p = o.getSharedOptions(g);
        const m = o.includeOptions(n, p);
      let x;
        let b = o._getRotation();
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta;
        ...
        const o = Ei(e._parsed[t], i.options.locale);
  ...
  class ho extends Ti {
    ...
    update(t) {
      const e = this;
        const i = e._cachedMeta;
        const { dataset: n, data: o = [], _dataset: s } = i;
        const a = e.chart._animationsDisabled;
      ...
      ((e._drawStart = r),
        ...
        (function (t) {
          const { xScale: e, yScale: i, _scaleRanges: n } = t;
            const o = { xmin: e.min, xmax: e.max, ymin: i.min, ymax: i.max };
    ...
    updateElements(t, e, i, n) {
      const o = this;
        const s = n === 'reset';
        const { xScale: a, yScale: r, _stacked: l } = o._cachedMeta;
        const c = o.resolveDataElementOptions(e, n);
        const h = o.getSharedOptions(c);
        const d = o.includeOptions(n, h);
        const u = o.options.spanGaps;
        const f = Ot(u) ? u : Number.POSITIVE_INFINITY;
        const g = o.chart._animationsDisabled || s || n === 'none';
      let p = e > 0 && o.getParsed(e - 1);
      for (let c = e; c < e + i; ++c) {
        const e = t[c];
          const i = o.getParsed(c);
          const u = g ? e : {};
          const m = $(i.y);
          const x = (u.x = a.getPixelForValue(i.x, c));
          const b = (u.y =
            s || m
              ? r.getBasePixel()
    ...
    getMaxOverflow() {
      ...
      const s = o[0].size(t.resolveDataElementOptions(0));
        const a = o[o.length - 1].size(t.resolveDataElementOptions(o.length - 1));
  ...
  class uo extends Ti {
    ...
    _updateRadius() {
      const t = this;
        ...
        const i = e.chartArea;
        const n = e.options;
        const o = Math.min(i.right - i.left, i.bottom - i.top);
        const s = Math.max(o / 2, 0);
        const a =
          (s -
            Math.max(
    ...
    updateElements(t, e, i, n) {
      const o = this;
        const s = n === 'reset';
        const a = o.chart;
        const r = o.getDataset();
        const l = a.options.animation;
        const c = o._cachedMeta.rScale;
        const h = c.xCenter;
        const d = c.yCenter;
        const u = c.getIndexAngle(0) - 0.5 * xt;
      let f;
        let g = u;
      ...
      for (f = e; f < e + i; f++) {
        const e = t[f];
        let i = g;
          let m = g + o._computeAngle(f, n, p);
          let x = a.getDataVisibility(f)
  ...
  class go extends Ti {
    ...
    updateElements(t, e, i, n) {
      const o = this;
        const s = o.getDataset();
        const a = o._cachedMeta.rScale;
        const r = n === 'reset';
      for (let l = e; l < e + i; l++) {
        const e = t[l];
          const i = o.resolveDataElementOptions(l, n);
          const c = a.getPointPositionForValue(l, s.data[l]);
          const h = r ? a.xCenter : c.x;
          const d = r ? a.yCenter : c.y;
          const u = {
            x: h,
            y: d,
            angle: c.angle,
  ...
  function yo(t, e) {
    const { x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a } = e;
      const r = Math.max(e.outerRadius - a, 0);
      const l = e.innerRadius + a;
      const {
        outerStart: c,
        outerEnd: h,
        innerStart: d,
      ...
      e.fullCircles &&
        (function (t, e, i) {
          const { x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r } = e;
            const l = Math.max(e.outerRadius - r, 0);
            const c = e.innerRadius + r;
          let h;
          for (
            i &&
  ...
  class wo extends Ri {
    ...
    inRange(t, e, i) {
      const n = this.getProps(['x', 'y'], i);
        const { angle: o, distance: s } = Ft(n, { x: t, y: e });
        const {
          startAngle: a,
          endAngle: r,
          innerRadius: l,
    ...
    draw(t) {
      const e = this;
        ...
        const n = i.offset || 0;
      if (
        ((e.pixelMargin = i.borderAlign === 'inner' ? 0.33 : 0),
  ...
  function Po(t, e, i, n) {
    const { points: o, options: s } = e;
      const { count: a, start: r, loop: l, ilen: c } = So(o, i, n);
      const h = (function (t) {
  ...
  function Do(t, e, i, n) {
    const o = e.points;
      const { count: s, start: a, ilen: r } = So(o, i, n);
      const { move: l = !0, reverse: c } = n || {};
    let h;
      let d;
      let u;
      let f;
  ...
  const Oo = typeof Path2D === 'function';
  function Ao(t, e, i, n) {
    Oo && e.segments.length === 1
      ? (function (t, e, i, n) {
          let o = e._path;
          (o ||
  ...
  class To extends Ri {
    ...
    interpolate(t, e) {
      const i = this;
        ...
        const o = t[e];
        const s = i.points;
        const a = vn(i, { property: e, start: o, end: o });
      if (!a.length) return;
      const r = [];
        const l = (function (t) {
  ...
  class Lo extends Ri {
    ...
    inRange(t, e, i) {
      const n = this.options;
        const { x: o, y: s } = this.getProps(['x', 'y'], i);
      return (
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, o) => {
        const { _data: s, indexAxis: a } = e;
          const r = t.getDatasetMeta(o);
          const l = s || e.data;
        if (ze([a, t.options.indexAxis]) === 'y') return;
              ...
              h = (function (t, e, i, n, o) {
                ...
                for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                  ...
                  const c = Math.floor((h + 1) * r) + 1 + e;
                    const m = Math.min(Math.floor((h + 2) * r) + 1, i) + e;
                    const x = m - c;
                  for (n = c; n < m; n++) ((o += t[n].x), (s += t[n].y));
                  ((o /= x), (s /= x));
                  const b = Math.floor(h * r) + 1 + e;
                    const _ = Math.floor((h + 1) * r) + 1 + e;
                    const { x: y, y: v } = t[p];
                  for (u = f = -1, n = b; n < _; n++)
                    ((f =
                      0.5 *
    ...
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          const { scale: e, fill: i } = t;
            const n = e.options;
            const o = e.getLabels().length;
            const s = [];
            const a = n.reverse ? e.max : e.min;
            const r = n.reverse ? e.min : e.max;
          let l, c, h;
          if (
            ((h =
              i === 'start'
  ...
  const Zo = (t) => t.type === 'line' && !t.hidden;
  function Qo(t, e, i) {
    const n = [];
    for (let o = 0; o < i.length; o++) {
      const s = i[o];
        const { first: a, last: r, point: l } = Jo(s, e, 'x');
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
  ...
  function ss(t, e, i) {
    const { top: n, bottom: o } = e.chart.chartArea;
      const { property: s, start: a, end: r } = i || {};
    s === 'x' && (t.beginPath(), t.rect(a, n, r - a, o - n), t.clip());
  }
  function as(t, e, i, n) {
  ...
  function ls(t, e, i) {
    const n = (function (t) {
        ...
        if (i === 'stack') return Go(t);
        const o = Ko(t);
        return o instanceof qo ? o : ts(o, n);
      })(e);
      const { line: o, scale: s, axis: a } = e;
      const r = o.options;
      const l = r.fill;
    ...
    beforeDatasetsDraw(t, e, i) {
      ...
      for (let e = n.length - 1; e >= 0; --e) {
        ...
        s &&
          ...
          i.drawTime === 'beforeDatasetsDraw' && ls(t.ctx, s, o));
      }
    },
  ...
  class ds extends Ri {
    ...
    fit() {
      const t = this;
        const { options: e, ctx: i } = t;
      if (!e.display) return void (t.width = t.height = 0);
      const n = e.labels;
        const o = Fe(n.font);
        const s = o.size;
        const a = t._computeTitleHeight();
        const { boxWidth: r, itemHeight: l } = hs(n, s);
      let c, h;
      ((i.font = o.string),
        t.isHorizontal()
    ...
    _fitRows(t, e, i, n) {
      const o = this;
        ...
        const l = (o.legendHitBoxes = []);
        const c = (o.lineWidths = [0]);
        const h = n + r;
      let d = t;
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        let a = 0;
          let r = o(n, t.left + s, t.right - t.lineWidths[a]);
        for (const l of i)
          (a !== l.row &&
        ...
        let a = 0;
          let r = o(n, t.top + e + s, t.bottom - t.columnSizes[a].height);
        for (const l of i)
          (l.col !== a &&
            ((a = l.col),
    ...
    _draw() {
      const t = this;
        const { options: e, columnSizes: i, lineWidths: n, ctx: a } = t;
        const { align: r, labels: l } = e;
        const c = mt.color;
        const h = pn(e.rtl, t.left, t.width);
        const d = Fe(l.font);
        const { color: u, padding: f } = l;
        const g = d.size;
        const p = g / 2;
      let m;
      (t.drawTitle(),
      ...
      (t.legendItems.forEach((e, M) => {
        ...
        const k = a.measureText(e.text).width;
          const S = h.textAlign(e.textAlign || (e.textAlign = l.textAlign));
          const P = x + g / 2 + k;
        let D = m.x;
          let C = m.y;
        (h.setWidth(t.width),
        ...
        (!(function (t, e, i) {
          ...
          if (
            ...
            const o = {
              ...
              const s = h.xPlus(t, x / 2);
            qt(a, o, s, e + p);
          } else {
            const o = e + Math.max((g - b) / 2, 0);
              const s = h.leftForLtr(t, x);
              const r = Ee(i.borderRadius);
            (a.beginPath(),
    ...
    handleEvent(t) {
      ...
      if (
        !(function (t, e) {
          if (t === 'mousemove' && (e.onHover || e.onLeave)) return !0;
  ...
  class fs extends Ri {
    ...
    draw() {
      ...
      if (!i.display) return;
      const o = Fe(i.font);
        const s = o.lineHeight / 2 + t._padding.top;
        const { titleX: a, titleY: r, maxWidth: l, rotation: c } = t._drawArgs(s);
      te(e, i.text, 0, 0, o, {
        color: i.color,
        maxWidth: l,
        rotation: c,
  ...
  function bs(t, e) {
    const { element: i, datasetIndex: n, index: o } = e;
      ...
      const { label: a, value: r } = s.getLabelAndValue(o);
    return {
      chart: t,
      label: a,
  ...
  function _s(t, e) {
    const i = t._chart.ctx;
      const { body: n, footer: o, title: s } = t;
      const { boxWidth: a, boxHeight: r } = e;
      const l = Fe(e.bodyFont);
      const c = Fe(e.titleFont);
      const h = Fe(e.footerFont);
      const d = s.length;
      const u = o.length;
      const f = n.length;
      const g = Ie(e.padding);
    let p = g.height;
      let m = 0;
      let x = n.reduce(
  ...
  function ws(t, e, i, n) {
    ...
    let d = (function (t, e) {
      let { x: i, width: n } = t;
      return (e === 'right' ? (i -= n) : e === 'center' && (i -= n / 2), i);
    })(e, r);
    const u = (function (t, e, i) {
      let { y: n, height: o } = t;
      return (
        e === 'top' ? (n += i) : (n -= e === 'bottom' ? o + i : o / 2),
        n
      );
    })(e, l, c);
    return (
  ...
  class Ps extends Ri {
    ...
    _resolveAnimations() {
      const t = this;
        const e = t._cachedAnimations;
      if (e) return e;
      const i = t._chart;
        const n = t.options.setContext(t.getContext());
        const o = n.enabled && i.options.animation && n.animations;
        const s = new yi(t._chart, o);
    ...
    getTitle(t, e) {
      const i = this;
        const { callbacks: n } = e;
        const o = n.beforeTitle.apply(i, [t]);
        const s = n.title.apply(i, [t]);
        const a = n.afterTitle.apply(i, [t]);
      let r = [];
    ...
    getFooter(t, e) {
      const i = this;
        const { callbacks: n } = e;
        const o = n.beforeFooter.apply(i, [t]);
        const s = n.footer.apply(i, [t]);
        const a = n.afterFooter.apply(i, [t]);
      let r = [];
      return ((r = ms(r, xs(o))), (r = ms(r, xs(s))), (r = ms(r, xs(a))), r);
    }
    ...
    update(t, e) {
      const i = this;
        const n = i.options.setContext(i.getContext());
        const o = i._active;
      let s;
        let a = [];
      if (o.length) {
        ...
        const e = (i._size = _s(i, n));
          ...
          const l = vs(i._chart, n, r);
          const c = ws(n, r, l, i._chart);
        ((i.xAlign = l.xAlign),
          (i.yAlign = l.yAlign),
          (s = {
            opacity: 1,
    ...
    getCaretPosition(t, e, i) {
      const { xAlign: n, yAlign: o } = this;
        const { cornerRadius: s, caretSize: a } = i;
        const { x: r, y: l } = t;
        const { width: c, height: h } = e;
      let d, u, f, g, p, m;
      return (
        o === 'center'
          ? ((p = l + h / 2),
    ...
    _drawColorBox(t, e, i, n, o) {
      const s = this;
        const a = s.labelColors[i];
        const r = s.labelPointStyles[i];
        const { boxHeight: l, boxWidth: c } = o;
        const h = Fe(o.bodyFont);
        const d = Ms(s, 'left', o);
        const u = n.x(d);
      ...
      if (o.usePointStyle) {
        ...
        const e = n.leftForLtr(u, c);
          const i = n.leftForLtr(n.xPlus(u, 1), c - 2);
          const s = Ee(a.borderRadius);
        Object.values(s).some((t) => t !== 0)
          ? (t.beginPath(),
            (t.fillStyle = o.multiKeyBackground),
    ...
    drawBody(t, e, i) {
      ...
      for (
        e.textAlign = a,
          ...
          J(n.beforeBody, g),
          u = r && p !== 'right' ? (a === 'center' ? c / 2 + 1 : c + 2) : 0,
          _ = 0,
          v = o.length;
        _ < v;
        ++_
    ...
    drawBackground(t, e, i, n) {
      const { xAlign: o, yAlign: s } = this;
        ...
        const h = n.cornerRadius;
      ((e.fillStyle = n.backgroundColor),
        (e.strokeStyle = n.borderColor),
        (e.lineWidth = n.borderWidth),
        e.beginPath(),
        e.moveTo(a + h, r),
        s === 'top' && this.drawCaret(t, e, i, n),
        e.lineTo(a + l - h, r),
        e.quadraticCurveTo(a + l, r, a + l, r + h),
        s === 'center' && o === 'right' && this.drawCaret(t, e, i, n),
        e.lineTo(a + l, r + c - h),
        e.quadraticCurveTo(a + l, r + c, a + l - h, r + c),
        s === 'bottom' && this.drawCaret(t, e, i, n),
        e.lineTo(a + h, r + c),
        e.quadraticCurveTo(a, r + c, a, r + c - h),
        s === 'center' && o === 'left' && this.drawCaret(t, e, i, n),
        e.lineTo(a, r + h),
    ...
    _updateAnimationTarget(t) {
      ...
      if (o || s) {
        ...
        const a = (e._size = _s(e, t));
          const r = Object.assign({}, n, e._size);
          const l = vs(i, t, r);
          const c = ws(t, r, l, i);
        (o._to === c.x && s._to === c.y) ||
          ((e.xAlign = l.xAlign),
    ...
    draw(t) {
      const e = this;
        const i = e.options.setContext(e.getContext());
      let n = e.opacity;
      if (!n) return;
    ...
    setActiveElements(t, e) {
      const i = this;
        const n = i._active;
        const o = t.map(({ datasetIndex: t, index: e }) => {
        ...
        const s = !tt(n, o);
        const a = i._positionChanged(o, e);
    ...
    _positionChanged(t, e) {
      const { caretX: i, caretY: n, options: o } = this;
        const s = ps[o.position].call(this, t, e);
  ...
  function Os(t, e, i) {
    ...
    if (n === -1)
      return ((t, e, i) =>
        typeof e === 'string' ? t.push(e) - 1 : isNaN(e) ? null : i)(t, e, i);
  ...
  class As extends Yi {
    ...
    parse(t, e) {
      ...
      return ((t, e) => (t === null ? null : Nt(Math.round(t), 0, e)))(
    ...
    determineDataLimits() {
      const t = this;
        const { minDefined: e, maxDefined: i } = t.getUserBounds();
    ...
    buildTicks() {
      const t = this;
        const e = t.min;
        const i = t.max;
        const n = t.options.offset;
        const o = [];
      let s = t.getLabels();
      ((s = e === 0 && i === s.length - 1 ? s : s.slice(e, i + 1)),
  ...
  class Ts extends Yi {
    ...
    handleTickRangeOptions() {
      const t = this;
        const { beginAtZero: e, stacked: i } = t.options;
        const { minDefined: n, maxDefined: o } = t.getUserBounds();
      let { min: s, max: a } = t;
      const r = (t) => (s = n ? s : t);
        const l = (t) => (a = o ? a : t);
      if (e || i) {
    ...
    getTickLimit() {
      const t = this;
        const e = t.options.ticks;
      let i;
        let { maxTicksLimit: n, stepSize: o } = e;
      return (
        o
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        const i = [];
          const { step: n, min: o, max: s, precision: a, count: r, maxTicks: l } = t;
          const c = n || 1;
          const h = l - 1;
          const { min: d, max: u } = e;
          const f = !$(o);
  ...
  class Rs extends Ts {
    determineDataLimits() {
      const t = this;
        const { min: e, max: i } = t.getMinMax(!0);
      ((t.min = X(e) ? e : 0),
        (t.max = X(i) ? i : 1),
  ...
  function Ls(t) {
    return t / Math.pow(10, Math.floor(St(t))) === 1;
  }
  ((Rs.id = 'linear'),
  ...
  class Es extends Yi {
    ...
    handleTickRangeOptions() {
      ...
      const s = (t) => (n = e ? n : t);
        const a = (t) => (o = i ? o : t);
        const r = (t, e) => Math.pow(10, Math.floor(St(t)) + e);
      ...
      const t = this;
        ...
        const i = (function (t, e) {
          const i = Math.floor(St(e.max));
            const n = Math.ceil(e.max / Math.pow(10, i));
            const o = [];
          let s = q(t.min, Math.pow(10, Math.floor(St(e.min))));
            let a = Math.floor(St(s));
            let r = Math.floor(s / Math.pow(10, a));
    ...
    getValueForPixel(t) {
      const e = this;
        const i = e.getDecimalForPixel(t);
  ...
  class Ns extends Ts {
    ...
    determineDataLimits() {
      const t = this;
        const { min: e, max: i } = t.getMinMax(!1);
    ...
    fit() {
      ...
      e.display && e.pointLabels.display
        ? (function (t) {
            ...
            for (n = 0; n < l; n++) {
              ...
              ((t.ctx.font = u.string),
                ...
                (o = Y((d = t._pointLabels[n]))
                  ...
                  : { w: c.measureText(d).width, h }),
                (a[n] = o));
              const f = t.getIndexAngle(n);
                const g = Et(f);
                const p = Fs(g, s.x, o.w, 0, 180);
                const m = Fs(g, s.y, o.h, 90, 270);
            ...
            const u = t.options;
              const f = Is(u);
              const g = t.getDistanceFromCenterForValue(
                u.ticks.reverse ? t.min : t.max
              );
            for (n = 0; n < l; n++) {
              const e = n === 0 ? f / 2 : 0;
                const i = t.getPointPosition(n, g + e + r[n]);
                const o = Et(t.getIndexAngle(n));
                const s = a[n];
              Vs(o, s, i);
              const l = zs(o);
              let c;
              c =
                l === 'left' ? i.x : l === 'center' ? i.x - s.w / 2 : i.x - s.w;
              const h = c + s.w;
    ...
    _setReductions(t, e, i) {
      ...
      let o = e.l / Math.sin(i.l);
        let s = Math.max(e.r - n.width, 0) / Math.sin(i.r);
        let a = -e.t / Math.cos(i.t);
        let r = -Math.max(e.b - (n.height - n.paddingTop), 0) / Math.cos(i.b);
      ((o = Ws(o)),
        (s = Ws(s)),
        (a = Ws(a)),
        (r = Ws(r)),
    ...
    setCenterPoint(t, e, i, n) {
      const o = this;
        const s = o.width - e - o.drawingArea;
        const a = t + o.drawingArea;
        const r = i + o.drawingArea;
        const l = o.height - o.paddingTop - n - o.drawingArea;
    ...
    getValueForDistanceFromCenter(t) {
      if ($(t)) return NaN;
      const e = this;
        const i = t / (e.drawingArea / (e.max - e.min));
      return e.options.reverse ? e.max - i : e.min + i;
    }

    getPointPosition(t, e) {
      const i = this;
        const n = i.getIndexAngle(t) - wt;
      return {
    ...
    drawGrid() {
      const t = this;
        const e = t.ctx;
        const i = t.options;
        const { angleLines: n, grid: o } = i;
        const s = t.getLabels().length;
      let a, r, l;
      if (
  ...
  function Ys(t, e) {
    ...
    const i = t._adapter;
      ...
      const { parser: o, round: s, isoWeekday: a } = n;
    let r = e;
    return (
      typeof o === 'function' && (r = o(r)),
      X(r) || (r = typeof o === 'string' ? i.parse(r, o) : i.parse(r)),
      r === null
        ? null
        : (s &&
            (r =
  ...
  function Us(t, e, i, n) {
    ...
    for (let s = js.indexOf(t); s < o - 1; ++s) {
      const t = Hs[js[s]];
        const o = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
  ...
  class Ks extends Yi {
    ...
    init(t, e) {
      const i = t.time || (t.time = {});
        const n = (this._adapter = new io._date(t.adapters.date));
    ...
    buildTicks() {
      const t = this;
        ...
        const i = e.time;
        const n = e.ticks;
        const o = n.source === 'labels' ? t.getLabelTimestamps() : t._generate();
      e.bounds === 'ticks' &&
        o.length &&
        ((t.min = t._userMin || o[0]), (t.max = t._userMax || o[o.length - 1]));
      const s = t.min;
        const a = se(o, s, t.max);
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
    ...
    initOffsets(t) {
      ...
      e.options.offset &&
        ...
        (o = t.length === 1 ? 1 - i : (e.getDecimalForValue(t[1]) - i) / 2),
    ...
    _generate() {
      const t = this;
        ...
        const o = t.options;
        const s = o.time;
        const a = s.unit || Us(s.minUnit, i, n, t._getLabelCapacity(i));
        const r = K(s.stepSize, 1);
        const l = a === 'week' && s.isoWeekday;
        const c = Ot(l) || !0 === l;
        const h = {};
      let d;
        let u;
      ...
      const g = o.ticks.source === 'data' && t.getDataTimestamps();
      for (d = f, u = 0; d < n; d = +e.add(d, r, a), u++) Xs(h, d, g);
      return (
        (d !== n && o.bounds !== 'ticks' && u !== 1) || Xs(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _tickFormatFunction(t, e, i, n) {
      const o = this;
        ...
        const r = o._unit;
        const l = o._majorUnit;
        const c = r && a[r];
        const h = l && a[l];
        const d = i[e];
        const u = l && h && d && d.major;
        const f = o._adapter.format(t, n || (u ? h : c));
        const g = s.ticks.callback;
    ...
    getPixelForValue(t) {
      const e = this;
        const i = e._offsets;
        const n = e.getDecimalForValue(t);
    ...
    getValueForPixel(t) {
      const e = this;
        const i = e._offsets;
        const n = e.getDecimalForPixel(t) / i.factor - i.end;
    ...
    _getLabelSize(t) {
      const e = this;
        const i = e.options.ticks;
        const n = e.ctx.measureText(t).width;
        const o = Lt(e.isHorizontal() ? i.maxRotation : i.minRotation);
        const s = Math.cos(o);
        const a = Math.sin(o);
        const r = e._resolveTickFontOptions(0).size;
      return { w: n * s + r * a, h: n * a + r * s };
    }

    _getLabelCapacity(t) {
      const e = this;
        const i = e.options.time;
        const n = i.displayFormats;
        const o = n[i.unit] || n.millisecond;
        const s = e._tickFormatFunction(t, 0, qs(e, [t], e._majorUnit), o);
        const a = e._getLabelSize(s);
        const r = Math.floor(e.isHorizontal() ? e.width / a.w : e.height / a.h) - 1;
      return r > 0 ? r : 1;
    }
  ...
  class Zs extends Ks {
    ...
    initOffsets() {
      const t = this;
        const e = t._getTimestampsForTable();
  ...
  return (
    ...
    (Zn.Chart = Zn),
    typeof window !== 'undefined' && (window.Chart = Zn),
    Zn
  );
});
