...
!(function (t, e) {
  ...
  function kt(t) {
    for (var e = dt(t), n = Tt(t); n && yt(n) && bt(n).position === 'static'; )
      n = Tt(n);
      ...
      fn: function (t) {
        ...
        if (o && r) {
          const c = n.modifiersData[i + '#persistent'].padding;
            ...
            const g = kt(o);
            const m = g ? (a === 'y' ? g.clientHeight || 0 : g.clientWidth || 0) : 0;
            const v = h / 2 - p / 2;
            const _ = c[f];
            const b = m - u[l] - c[d];
            const y = m / 2 - u[l] / 2 + v;
  ...
  function Xt(t, e) {
    ...
    const n = e;
      ...
      const w = Rt(v);
      const E = Vt({ reference: w, element: _, strategy: 'absolute', placement: o });
  ...
  const ie = {
    ...
    fn: function (t) {
      const e = t.state;
        ...
        const m = Xt(e, { boundary: l, rootBoundary: c, padding: f, altBoundary: u });
      ...
      return (
        ...
        (o.clearMenus = function (t) {
          if (!t || (t.button !== 2 && (t.type !== 'keyup' || t.key === 'Tab')))
            for (
              let e = q.find('[data-bs-toggle="dropdown"]'),
                n = 0,
                i = e.length;
              n < i;
              n++
  ...
  const qe = 'scrollspy';
    ...
    const Xe = (function (t) {
      ...
      return (
        ...
        (r._getConfig = function (t) {
          if (
            typeof (t = n({}, ze, typeof t === 'object' && t ? t : {}))
                .target !==
              'string' &&
            d(t.target)
          ) {
