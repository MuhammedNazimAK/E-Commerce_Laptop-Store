          ...
          return (
            ...
            (r.prototype.displayMessage = function (e) {
              ...
              const n = p(
                ...
                const r = this.options.get('translations').get(e.message);
              (n.append(t(r(e.args))),
            ...
            (r.prototype.setClasses = function () {
              ...
              this.data.current(function (e) {
                ...
                t.$results
                  ...
                  .each(function () {
                    const e = p(this);
                      const t = h.GetData(this, 'data');
                      const n = '' + t.id;
                    (t.element != null && t.element.selected) ||
                    (t.element == null && p.inArray(n, r) > -1)
            ...
            (r.prototype.option = function (e) {
              ...
              const n = { role: 'treeitem', 'aria-selected': 'false' };
              for (const r in (e.disabled &&
                ...
                t.on('results:next', function () {
                  ...
                  if (!(n >= t.length)) {
                    ...
                    const i =
                      ...
                      const o = r.offset().top + r.outerHeight(!1);
                      const s = l.$results.scrollTop() + o - i;
                    n === 0
                      ? l.$results.scrollTop(0)
                ...
                p.fn.mousewheel &&
                  this.$results.on('mousewheel', function (e) {
                    const t = l.$results.scrollTop();
                      ...
                      const r = e.deltaY > 0 && t - e.deltaY <= 0;
                      const i = e.deltaY < 0 && n <= l.$results.height();
                    r
                      ? (l.$results.scrollTop(0),
                        e.preventDefault(),
                        e.stopPropagation())
            ...
            return (
              ...
              (n.prototype.update = function (e) {
                if ((this.clear(), e.length !== 0)) {
                  ...
                  const s = this.$selection.find('.select2-selection__rendered');
                  a.appendMany(s, t);
                }
              }),
              n
        ...
        e.define('select2/data/tokenizer', ['jquery'], function (d) {
          ...
          return (
            ...
            (e.prototype.query = function (e, t, n) {
              const r = this;
              t.term = t.term || '';
              const i = this.tokenizer(t, this.options, function (e) {
          ...
          return (
            (e.prototype.query = function (n, r, i) {
              ...
              this.current(function (e) {
                ...
                o.maximumSelectionLength > 0 && t >= o.maximumSelectionLength
        ...
        e.define('select2/dropdown/infiniteScroll', ['jquery'], function (i) {
          ...
          return (
            ...
            (e.prototype.loadMore = function () {
              this.loading = !0;
              const e = i.extend({}, { page: 1 }, this.lastParams);
          ...
          function (
            ...
            return (
              (n.prototype.apply = function (t) {
                if (
                  (t = f.extend(!0, {}, this.defaults, t)).dataAdapter == null
                ) {
                  if (
                    (t.ajax != null
                      ? (t.dataAdapter = E)
                ...
                if (t.selectionAdapter == null) {
                  if (
                    ...
                    t.containerCssClass != null ||
                      t.containerCss != null ||
                      t.adaptContainerCssClass != null)
                  ) {
                    const o = g(t.amdBase + 'compat/containerCss');
                ...
                if (typeof t.language === 'string')
                  if (t.language.indexOf('-') > 0) {
                    const s = t.language.split('-')[0];
                    t.language = [t.language, s];
                  } else t.language = [t.language];
                if (f.isArray(t.language)) {
                  const a = new x();
                  t.language.push('en');
                  for (let l = t.language, c = 0; c < l.length; c++) {
                    let u = l[c];
                      let d = {};
                    try {
                      d = x.loadPath(u);
                  ...
                  const p = x.loadPath(this.defaults.amdLanguageBase + 'en');
                    const h = new x(t.language);
