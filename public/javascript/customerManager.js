class CustomerManager {
  ...
  initEventListeners() {
    ...
    document
      ...
      .addEventListener('change', this.handleStatusChange.bind(this));
    document
      .getElementById('itemsPerPage')
      .addEventListener('change', this.handleLimitChange.bind(this));
  }
  ...
  updatePagination(data) {
    ...
    document.getElementById('customerCount').textContent =
      `Showing ${data.userData.length} of ${data.totalUsers} customers`;
  }
