...
//     processor: document.getElementById('product_processor')?.value.trim(),
//     ram: document.getElementById('product_ram')?.value.trim(),
//     storage: document.getElementById('product_storage')?.value.trim(),
//     graphicsCard: document.getElementById('product_graphicsCard')?.value.trim(),

//     color: document.getElementById('product_color')?.value.trim(),

//     price: Number(document.getElementById('product_regularPrice')?.value),
//     salePrice: Number(document.getElementById('product_salesPrice')?.value) || null,
//     stock: Number(document.getElementById('product_stockAvailability')?.value),
